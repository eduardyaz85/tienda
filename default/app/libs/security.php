...
class Security {
    ...
    /**
     * Constante de llave de seguridad API KEY
     */
    //desarrollo
    const API_KEY_TEST = '85291f9e-96aa-4e3f-abb5-a5956cdfbb49';

    /**
     * Constante de llave de seguridad API KEY
     */
    //desarrollo
    const ACCESS_KEY_TEST = '70bef06b-aae5-4440-8465-f91761aefacc';
    ...
    /**
     * Función clave api key
     */
    static public function claveApiKey() {
        $apikey = self::API_KEY_TEST;
        return $apikey;
    }
     ...
     * Función access key
     */
    static public function accessApiKey() {
        $accesskey = self::ACCESS_KEY_TEST;
        return $accesskey;
    }
